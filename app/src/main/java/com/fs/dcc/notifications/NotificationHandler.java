package com.fs.dcc.notifications;
...
/**
 * Created by danielcintoconde on 26/04/18.
 */
...
public class NotificationHandler extends ContextWrapper {
    ...
    private Notification.Builder createNotificationWithChannel(String title, String message, String channelId) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            Notification.Action action = new Notification.Action.Builder(
                createWithResource(this, android.R.drawable.ic_menu_send),
                "See details",
                pendingIntent
            ).build();
    ...
    public void publishNotificationSummaryGroup(boolean isHighImportance) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            Notification summaryNotification= new Notification.Builder(getBaseContext(), channelId)
